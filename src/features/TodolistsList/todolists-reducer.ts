...
export const deleteTodolist = (todolistId: string) => async (dispatch: Dispatch<ActionsType>) => {
...
export const updateTodolistTitle = (todolistId: string, title: string) => async (dispatch: Dispatch<ActionsType>) => {
